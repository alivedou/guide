...
// KV 文件目录：默认 local_kv/。测试可设 KV_DIR 以免打到开发者数据。
const KV_DIR = process.env.KV_DIR || path.join(__dirname, 'local_kv');
...
const EMAIL_FROM = process.env.EMAIL_FROM || 'CloudNav Alerts <alerts@cloudnav.tech>';
